;(function() {
    ...
    var form_locale = {
        ...
        ja: {
            ...
            last_name: "姓",
            email: "メールアドレス",
            first_name_error: "名は必須です",
            last_name_error: "姓は必須です",
            email_error: "メールアドレスは必須です",
            phone_error: "電話番号は必須です",
            btn_step_1: "次へ",
            btn_step_2: "今すぐ始める",
            loading: "読み込み中...",
            terms: '<input class="form-check-input" type="checkbox" checked id="terms-checkbox" style="width:auto;height:auto;"> 利用規約および <a href="terms.html" target="_blank">利用規約</a>、<a href="privacy.html" target="_blank">プライバシーポリシー</a> に同意します',
            thanksmsg: "ご登録ありがとうございます！入力いただいたメールアドレスに、アクティベーションリンクを含むメールを送信しました。"
        }        
    };
